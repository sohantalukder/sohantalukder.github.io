        ...
        <div className='container mx-auto' id='home'>
            <div className='bg-dark1 flex md:gap-16 items-center md:px-[60px] px-5 py-8 md:py-0 justify-between'>
                <div className='w-full md:w-1/2 text-center md:text-left  '>
                    <div>
                        <h1 className='text-2xl md:text-3xl lg:text-5xl font-bold  text-gray '>
                            I'm Md. Sohan Talukder
                        </h1>
                        <h1 className='text-2xl md:text-3xl lg:text-5xl font-bold  text-gray mt-2'>
                            <span className='text-yellow1'>Software</span>{" "}
                            Engineer
                        </h1>
                    </div>
                    <p className='text-text text-sm md:text-base mt-[18px]'>
